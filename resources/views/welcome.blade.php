            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex h-[32rem]">
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2 rounded py-1 px-5">
                    ...
                    <div data-aos="fade-left" data-aos-duration="2000"
                        ...
                        <img alt=""
                            src="https://res.cloudinary.com/drcyxqm6p/image/upload/v1683476273/WEA_xstezw.jpg"
                            class="rounded h-40 w-full object-cover object- sm:h-56 md:h-full skew-y-6" />

                        <img alt=""
                            src="https://res.cloudinary.com/drcyxqm6p/image/upload/v1683475722/eye-care-products-orange-background-with-copy-space_23-2148320317_m4fwr6.jpg"
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div data-aos="fade-down" data-aos-duration="1000" class="mb-8 w-full lg:mb-16">
                ...
                <p class="text-gray-500 text-center sm:text-xl dark:text-gray-400">
                    Our dental clinic offers a wide range of services to help you achieve and maintain
                    excellent oral health. Our highly skilled and experienced dental professionals provide
                    personalized and compassionate care to patients of all ages.
                </p>
            </div>
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">
                        our dental clinic, we believe in keeping our patients
                        informed and up-to-date on any changes or updates that may
                        affect their dental care. We strive to provide real-time updates to our patients
                    </p>
                </div>
                <div data-aos="fade-up" data-aos-duration="2000">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">
                        Our dental clinic is open for appointments Monday through Friday,
                        and we offer extended hours to accommodate the busy schedules of our patients
                    </p>
                </div>
                <div data-aos="fade-up" data-aos-duration="3000">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">
                        We provide messenger page inside the system for barangay officials
                        and residents, making it easier for residents to reach out to them
                        for assistance.
                    </p>
                </div>
            </div>
        ...
        <div class="gap-16 items-center py-0 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:pb-16 lg:px-6">
            <div data-aos="fade-right" data-aos-duration="1000"
                ...
                <p class="mb-4">
                    ...
                    and ophthalmologists work together to provide personalized care for each patient.
                </p>
                <p>
                    At Barangay Mapulang Lupa Complain System, we are committed to
                    building a better barangay, one complaint at a time. Join us in
                    making a positive change in our community by utilizing our platform
                    and working together towards a brighter future for all.
                </p>
            </div>
            <div data-aos="fade-down" data-aos-duration="1000" class="grid grid-cols-2 gap-4 mt-8">
                <img class="w-full rounded-lg"
                    src="https://res.cloudinary.com/drcyxqm6p/image/upload/v1683476622/consultations-are-over-for-the-day_mbynwx.jpg"
                    alt="office content 1" />
                <img class="mt-4 w-full rounded-lg lg:mt-10"
                    src="https://res.cloudinary.com/drcyxqm6p/image/upload/v1683476623/about-our-office-1024x684_k6mljm.jpg"
        ...
        <div data-aos="fade-dowm" data-aos-duration="2000"
            ...
            <div class="max-w-screen-lg text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <p class="mb-4 font-light">
                    ...
                    people by providing them with easy access to comprehensive eye care services,
                        ...
                        <button class="faq-btn flex w-full text-left" @click="openFaq1 = !openFaq1">
                            ...
                            <div class="w-full">
                                <h4 class="text-lg font-semibold text-black mb-7">
                                    What is the Dental Eye Clinic System?
                                </h4>
                            </div>
                        </button>
                        <div x-show="openFaq1" class="faq-content pl-[62px]">
                            <p class="py-3 text-base leading-relaxed text-body-color">
                                It's important to note that without more information, my understanding
                                of the "Dental Eye Clinic System" is speculative, and it is possible that
                                there is a specific system or software with that name that is different from my
                                assumptions.
                            </p>
                        </div>
                    </div>
                        ...
                        <button class="faq-btn flex w-full text-left" @click="openFaq3 = !openFaq3">
                            ...
                            <div class="w-full">
                                <h4 class="text-lg font-semibold text-black">
                                    What is the purpose of dental eye clinic system?
                                </h4>
                            </div>
                        </button>
                        <div x-show="openFaq3" class="faq-content pl-[62px]">
                            <p class="py-3 text-base leading-relaxed text-body-color">
                                Overall, the purpose of a dental eye clinic system is to improve
                                the efficiency and effectiveness of a clinic, leading to better
                                patient outcomes and a more successful practice.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="w-full px-4 lg:w-1/2">
                    <div data-aos="fade-left" data-aos-duration="1000"
                        ...
                        <button class="faq-btn flex w-full text-left" @click="openFaq4 = !openFaq4">
                            ...
                            <div class="w-full">
                                <h4 class="text-lg font-semibold text-black">
                                    what will be the benefits on people after taking such sunglasses ?
                                </h4>
                            </div>
                        </button>
                        <div x-show="openFaq4" class="faq-content pl-[62px]">
                            <p class="py-3 text-base leading-relaxed text-body-color">
                                Overall, wearing sunglasses that offer UV protection can help
                                to protect your eyes from harm and improve your vision and comfort in bright sunlight.
                            </p>
                        </div>
                    </div>
                    <div data-aos="fade-left" data-aos-duration="2000"
                        ...
                        <button class="faq-btn flex w-full text-left" @click="openFaq5 = !openFaq5">
                            ...
                            <div class="w-full">
                                <h4 class="text-lg font-semibold text-black">
                                    How long it takes sunglasses from dental eye clinic?
                                </h4>
                            </div>
                        </button>
                        <div x-show="openFaq5" class="faq-content pl-[62px]">
                            <p class="py-3 text-base leading-relaxed text-body-color">
                                In general, it is a good idea to check with the dental eye clinic to get an estimate of
                                how long it
                                will take to receive your sunglasses. They should be able to give you a better idea of
                                the timeline
